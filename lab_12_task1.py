...
def move_func(s, t):
    (x1, v_x1, y1, v_y1,
     x2, v_x2, y2, v_y2, x3, v_x3, y3, v_y3) = s
    ...
    return (dxdt1, dv_xdt1, dydt1, dv_ydt1,
            dxdt2, dv_xdt2, dydt2, dv_ydt2, dxdt3, dv_xdt3, dydt3, dv_ydt3)
...
def animate(i):
    ...
    ball3.set_data(solve_func(i, 'point')[0])
    ball_line3.set_data(solve_func(i, 'line')[0])
